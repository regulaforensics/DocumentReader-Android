...
Sample project in Kotlin, demonstrating the Document Reader SDK integration with the Advanced Card System devices.
...
2. Open the `AcsDevice` project in an IDE.
3. Copy the database file `db.dat` from [Regula Client Portal](https://client.regulaforensics.com/customer/databases) to the project: `AcsDevice/app/src/main/assets/Regula/`
4. Run the project.
