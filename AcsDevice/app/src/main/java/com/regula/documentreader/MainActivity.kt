...
class MainActivity : AppCompatActivity() {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if (requestCode == REQUEST_BROWSE_PICTURE) {
                    if (data!!.data != null) {
                        ...
                        val config = RecognizeConfig.Builder(DocumentReader.Instance().processParams().scenario)
                            .setBitmap(bmp!!)
                            .build()
    ...
    private fun initView() {
        ...
        showScanner!!.setOnClickListener { _: View? ->
            ...
            val scannerConfig =
                ScannerConfig.Builder(DocumentReader.Instance().processParams().scenario).build()
        ...
        scenarioLv!!.onItemClickListener =
            OnItemClickListener { adapterView: AdapterView<*>, _: View?, i: Int, _: Long ->
                ...
                DocumentReader.Instance().processParams().scenario = adapter.getItem(i).toString()
        ...
        license?.let {
            ...
            DocumentReader.Instance().initializeReader(
                ...
                if (!success) { //Initialization was not successful
                    Toast.makeText(this@MainActivity, "Init failed:$error", Toast.LENGTH_LONG)
                        .show()
    ...
    private fun startChipReading() {
        when (nfcRadioGroup?.checkedRadioButtonId) {
            R.id.nativeTagButton -> DocumentReader.Instance()
