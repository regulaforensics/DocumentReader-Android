...
Sample project in Kotlin, demonstrating the Document Reader SDK basic functionality.
...
2. Open the `Basic/DocumentReader-sample_kotlin` project in an IDE.
3. Add license and database files to the project:
   ...
   - Copy the license file to the project: `Basic/DocumentReader-sample_kotlin/app/src/main/res/raw/`
   - Copy the database file `db.dat` from the [Client Portal](https://client.regulaforensics.com/customer/databases) to the project: `Basic/DocumentReader-sample_kotlin/app/src/main/assets/Regula/`
