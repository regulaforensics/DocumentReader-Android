...
3. Open the `Basic/DocumentReader-sample_kotlin` project in an IDE.
4. Copy the license file to the project: `Basic/DocumentReader-sample_kotlin/app/src/main/res/raw/`.
5. Copy the database file db.dat from [Client Portal](https://client.regulaforensics.com/customer/databases) to the project: `Basic/DocumentReader-sample_kotlin/app/src/main/assets/Regula/`.
